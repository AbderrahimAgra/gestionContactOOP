...
if(isset($_POST['update'])){
    ...
    if($con->update()==true)  header("Location: contacts_liste.php");


}
// var_dump($_GET['idUpdate']);
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="d-flex justify-content-center align-items-center w-100" >
              <div class="rounded-3 w-50 card shadow p-3 mb-5 bg-body rounded p-5 m-5 " >
                ...
                <form action="" method="POST" onsubmit="return validation()">  
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter name" value="<?php echo $rows['name']; ?>" />
                  ...
                  <span id="nameid" style="color:red; font-weight: bold;"></span>
                    ...
                    <div class="mb-3 ">
                      ...
                      <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter phone" value="<?php echo $rows['phone']; ?>" >
                  ...
                  <div class="mb-3"  >
                    ...
                    <input type="text" class="form-control" id="adress" name="adress" rows="3"  value="<?php echo $rows['adress']; ?>" >
